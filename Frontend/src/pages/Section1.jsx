...
//             className="sticky text-base font-medium py-2 px-4 bg-transparent hover:bg-white/10 rounded-lg flex items-center transition-all duration-200 outline-none"
//           >
//             Dashboard <i class="ri-arrow-right-line mt-1 ml-1"></i>
//           </button>) : (<button onClick={() => { navigate('login') }} className="sticky text-base font-medium py-2 px-4 bg-transparent hover:bg-white/10 rounded-lg flex items-center transition-all duration-200 outline-none">LogIn  <i class="ri-arrow-right-line mt-1 ml-1"></i></button>)}

//         </div>
//         {/* <i class=" menu ri-menu-line text-lg text-white/80 md:hidden"></i> */}
//         <button
...
//                 className="w-full text-base font-medium py-3 px-4 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-all duration-200 outline-none"
//               >
//                 Dashboard
...
//         {/* Mobile Sidebar */}
//         <div className={`fixed top-0 right-0 h-full w-80 bg-gray-900 text-white transform transition-transform duration-300 ease-in-out z-50 md:hidden ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
//           }`}>
...
//             <button onClick={() => navigate('/dashboard')} className="bg-[#BEF264] hover:bg-green-500 text-black font-medium py-2 px-4 rounded-lg text-sm inline-flex items-center transition-all duration-200 outline-none">
//               Create Interview
    ...
    <div className="relative">
      ...
      <div className="container px-4 py-10 text-center">
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <button
            onClick={() => navigate('/dashboard')}
            className="bg-[#BEF264] hover:bg-green-500 text-black font-medium py-2 px-4 rounded-lg text-sm inline-flex items-center transition-all duration-200 outline-none"
          >
            Create Interview
            <i className="ri-arrow-right-line text-lg ml-1 mt-1"></i>
          </button>
