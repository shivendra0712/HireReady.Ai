const Section9 = () => {
  return (
    <div className='w-full flex flex-col justify-between items-center gap-4 py-6 lg:py-16 px-4 md:px-6 lg:px-1 '>
      ...
      <button className="bg-[#BEF264] hover:bg-green-500 text-black font-medium py-2 px-4 rounded-lg text-sm inline-flex items-center transition-all duration-200">Get Started for free</button>
    </div>
  )
}
