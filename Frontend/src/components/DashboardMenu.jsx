      ...
      <div className="w-full h-full bg-[#09090B] p-4 flex flex-col">
        ...
        <nav className="flex-1">
          <div className="mb-8">
            ...
            <ul>
              <li className="">
                <a href="#" className="flex items-center text-gray-200 hover:text-white font-medium outline-none">
                  <img className='scale-70' src="/images/img1.png" alt="" />
                  Progress
                </a>
              </li>
              <li className="">
                <a href="/interviews" className="flex items-center text-gray-200 hover:text-white font-medium">
